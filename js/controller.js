...
canvas.addEventListener("touchmove", function (event) {
    ...
    if (event.touches.length == 1) {
        ...
        scroolInertia.speedY = 20 * (touches.newEvent.touches[0].clientY - touches.oldEvent.touches[0].clientY)
            ...
            camera.x += (touches.newEvent.touches[0].clientX - touches.oldEvent.touches[0].clientX)/camera.scale;
            camera.y += (touches.newEvent.touches[0].clientY - touches.oldEvent.touches[0].clientY)/camera.scale;
